...
private Globals GetGlobals()
{
    ...
    globals.ModIdentifier = "HotSpot";
    globals.ModName = "Hot Spot";
    globals.ModCopyrightDates = "2015-2021";
    globals.KspLibs = new []
    {
        "Assembly-CSharp.dll",
...
Task("InitLibKsp")
    .Does(() =>
{
    const string kspLibsUrlBase = "https://build.apokee.com/dependencies/ksp/1.11.0.3045";
    ...
    .Does(() =>
{
    ...
    MSBuild(globals.Solution, s => { s.Configuration = globals.Configuration; });
});
    ...
    .Does(() =>
{
    ...
    CopyFiles(
        GetFiles(string.Format("{0}/*.dll", binDirectory)),
